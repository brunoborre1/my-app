							...
							<div id="rev_slider_1_1" class="rev_slider" style="display:none;">
								<ul>
									<li data-transition="fade" data-slotamount="7" data-masterspeed="900" >
										<img src="http://placehold.it/922x385" alt="image" />
										<div class="tp-caption lfl"
											 data-x="-19"
											 data-y="408"
											 data-speed="300"
											 data-start="500"
											 data-easing="easeInSine"  ><img src="images/slider/glow.png" alt="Image 1"></div>
										<div class="tp-caption very_large_text lft"
											 data-x="48"
											 data-y="261"
											 data-speed="800"
											 data-start="1700"
											 data-easing="easeOutBounce"  >Delicious</div>
										<div class="tp-caption medium_text lfr"
											 data-x="41"
											 data-y="441"
											 data-speed="300"
											 data-start="500"
											 data-easing="easeInSine"  >Serving quality foods that will make you remember coming back to us ! MORE & MORE !!</div>
										<div class="tp-caption randomrotate"
											 data-x="42"
											 data-y="350"
											 data-speed="300"
											 data-start="1100"
											 data-easing="easeInSine"  ><img src="images/slider/L1.png" alt="Image 4"></div>
										<div class="tp-caption randomrotate"
											 data-x="42"
											 data-y="359"
											 data-speed="300"
											 data-start="1400"
											 data-easing="easeInSine"  ><img src="images/slider/L2.png" alt="Image 5"></div>
									</li>
									<li data-transition="fade" data-slotamount="7" data-masterspeed="900" >
										<img src="http://placehold.it/922x385" alt="image" />
										<div class="tp-caption lfl"
										...
										<div class="tp-caption very_large_text lft"
											 ...
											 data-speed="800"
											 data-start="1700"
											 data-easing="easeOutBounce"  >Yummmi</div>
										<div class="tp-caption medium_text lfr"
											 data-x="41"
											 data-y="441"
											 data-speed="300"
									...
									<li data-transition="fade" data-slotamount="7" data-masterspeed="900" >
										...
										<div class="tp-caption very_large_text lft"
											 ...
											 data-speed="800"
											 data-start="1700"
											 data-easing="easeOutBounce"  >Fabolous</div>
										<div class="tp-caption medium_text lfr"
											 data-x="41"
											 data-y="441"
											 data-speed="300"
		...
		<section id="module">
			<div class="container">
				<div class="main-body-top">
					<div class="main-body-top-sitebar"></div>
					<div class="main-body-top-mid"></div>
					<div class="main-body-top-sitebar"></div>
				</div>
					...
					<div id="feature" class="row ">
						...
						<div class="col-md-4 col-sm-4">
							<div class="content-box">
								...
								<div class="img effects clearfix">
									<a href="images/f2.png"><img src="http://placehold.it/550x297"  alt="image"/></a>
									<div class="overlay">
										<a  href="http://placehold.it/550x297" rel="prettyPhoto[pp]" class="expand">+</a>
										<a class="close-overlay hidden">x</a>
									</div>
						...
						<div class="col-md-4 col-sm-4">
							<div class="content-box">
								<h2>Lovely Atmosphere</h2>
								<div class="img effects clearfix">
									<a href="images/f3.jpg"><img src="http://placehold.it/550x297"  alt="image"/></a>
									<div class="overlay">
										<a  href="http://placehold.it/550x297" rel="prettyPhoto[pp]" class="expand">+</a>
										<a class="close-overlay hidden">x</a>
									</div>
				...
				<div class="shadow">
					<img src="images/shadow.png" alt="image">
				</div>
			</div><!--.container-->
		</section><!--#module-->
		<!-- End Moudule-->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 col-lg-4">
						<div class="bottom-box">
							<h3>Resarvation</h3>
							<a href="reservation.html"><p><span>Resarvation For  </span>Click Here</p></a>
						</div>
					</div>
					
					<div class="col-md-4 col-sm-4 col-lg-4">
						<div class="bottom-box">
							<h3>Redbowl Hotline</h3>
							<p>123456789, 05-8837681</p>
						</div>
					</div>
				</div><!--.row-->
			</div><!--.container-->
		...
		<section id="footer" class="text-center">
			<div class="container">
				<div class="footer-content">
					<h4>REDBOWL RESTAURANT, Block-69/B, Road-30, West Dowtown, Miami, Florida</h4>
					<p>Redbowl Restaurant by <span>Themelan</span>, Built on Bootstrap Framework</p>
				</div>
